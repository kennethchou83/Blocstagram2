        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (granted) {
                ...
                if (!input) {
                    ...
                    [self UIAlertControllerTitle:error.localizedDescription message:error.localizedRecoverySuggestion];
                } else {
                    // #7
                ...
                [self UIAlertControllerTitle:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title") message:NSLocalizedString(@"This app doesn't have permission to use the camera; please update your privacy settings.", @"camera permission denied recovery suggestion")];
            }
        });
    }];
}
...
-(void) UIAlertControllerTitle:(NSString *) alertTitle message:(NSString *) message{
